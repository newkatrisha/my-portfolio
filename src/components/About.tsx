        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1 animate-fade-up">
            ...
            <p className="text-severance-navy/80 mb-6">
              ...
              a commitment to creating clean, efficient, and intuitive user
              interfaces. With a background in modern JavaScript frameworks and
              a deep understanding of responsive design principles, I bring
              ideas to life through code.
            </p>

            <p className="text-severance-navy/80 mb-6">
              My approach combines technical precision with creative
              problem-solving, ensuring that each project not only functions
              flawlessly but also delivers an exceptional user experience. I
              specialize in React, Next.js, and React Native development,
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
              <div className="severance-card">
                ...
                <p className="text-sm text-severance-navy/70">
              ...
              <div className="severance-card">
                ...
                <p className="text-sm text-severance-navy/70">
                  Building native-like experiences with React Native
                </p>
              </div>
          ...
          <div
            className="order-1 lg:order-2 relative animate-fade-up"
